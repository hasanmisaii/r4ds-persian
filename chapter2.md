...
نام شئ‌ها بایستی با یک حرف شروع شوند و می‌توانند شامل حروف، اعداد، `_` و `.` باشند. شما می خواهید که نام شئ‌ها توصیفی باشند، بنابراین نیاز دارید شرایطی را برای چندین کلمه اتخاذ کنید. ما شیوه  **snake_case** را پیشنهاد کنیم به طوری که کلمات با حروف کوچک با `_` از هم جدا می‌شوند.
```{r}
i_use_snake_case
