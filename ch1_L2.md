# درس 2: چارچوب و مفاهیم پایه
در گذشته تجربه ی اجرای کد R را برای شما فراهم کرد. اگر چه اطلاعات و جزئیات خیلی زیادی مطرح نشد، اما انتظار می رود مفاهیم پایه ای را درک کرده باشید.
