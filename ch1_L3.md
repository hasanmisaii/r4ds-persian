...
4. `flights` را مرتب کنید تا سریع‌ترین پروازها را پیدا کنید.

5. آیا در هر روز از سال 2013 پروازی بود؟

6. کدام پروازها بیشترین فاصله را طی کردند؟
   کدام‌ها کمترین فاصله را طی کردند؟

7. آیا ترتیب استفاده از `filter()` و `arrange()` اگر از هر دو استفاده می‌کنید مهم است؟
   چرا/چرا نه؟
