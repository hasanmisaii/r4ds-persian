...
مهم‌ترین کار گروه‌بندی خلاصه‌سازی است که اگر برای محاسبه یک آماره خلاصه استفاده شود، مجموعه داده را به یک سطر واحد برای هر گروه کاهش می‌دهد. در بسته dplyr، این عملیات توسط `()summarize` انجام می‌شود، همانند مثال زیر که میانگین تأخیر حرکت پروازها را بر حسب ماه محاسبه می‌کند:
