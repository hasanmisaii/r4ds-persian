...
در این فصل یاد خواهید گرفت که چگونه همه اینها (و بیشتر!) را انجام دهید، که شما را با تبدیل داده‌ها با استفاده از بسته **dplyr** و مجموعه داده جدیدی درباره پروازهایی که در سال 2013 از شهر نیویورک حرکت کردند، آشنا خواهد کرد.
...
`flights` یک tibble است، نوع خاصی از data frame که توسط tidyverse استفاده می‌شود تا از برخی مشکلات رایج جلوگیری کند.
