...
"تصویر ساده بهتر از هزار کلمه است." - آرتور بروسفلد، 1921

این فصل به شما نحوه تصویرسازی داده‌های خود با استفاده از ggplot2 را آموزش می‌دهد. R دارای چندین سیستم برای ساخت نمودار است، اما ggplot2 یکی از جامع‌ترین و زیباترین آن‌هاست. ggplot2 یک سیستم است که به شما امکان می‌دهد نمودارها را لایه به لایه بسازید.

### پیش‌نیازها

این فصل بر روی ggplot2 تمرکز می‌کند که یکی از اعضای اصلی tidyverse است. برای دسترسی به مجموعه داده‌ها، صفحات راهنما و توابعی که در این فصل استفاده می‌شوند، بسته‌های زیر را با اجرای این کد بارگذاری کنید:
...
این یک خط کد کتابخانه tidyverse را بارگذاری می‌کند. این کتابخانه شامل بسته‌های متعددی است که در تحلیل داده‌های روزمره استفاده می‌شوند. از جمله ggplot2 برای تصویرسازی داده‌ها و dplyr برای تبدیل داده‌ها.
...
شما فقط باید یک بار یک بسته را نصب کنید، اما هر بار که یک جلسه جدید شروع می‌کنید باید آن را بارگذاری کنید.

علاوه بر tidyverse، ما همچنین از بسته palmerpenguins استفاده خواهیم کرد که شامل مجموعه داده `penguins` با مشاهدات جمع‌آوری شده توسط دکتر کریستن گورمن در ایستگاه تحقیقاتی پالمر در قطب جنوب است و بسته ggthemes که مجموعه‌ای رنگارنگ از تم‌ها برای ggplot2 ارائه می‌دهد.
